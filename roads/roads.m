...
% ROADS MATLAB code for roads.fig
...
%
%      ROADS('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in ROADS.M with the given input arguments.
%
%      ROADS('Property','Value',...) creates a new ROADS or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before roads_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to roads_OpeningFcn via varargin.
%
...
% Last Modified by GUIDE v2.5 23-Mar-2015 22:31:54
...
% varargin   command line arguments to roads (see VARARGIN)
