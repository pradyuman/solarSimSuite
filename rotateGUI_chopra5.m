...
%
%  Program Description: This GUI calculates and compares the energy generated by a rotating solar
%  panel to a stationary solar panel over the course of a day and over the course of a
%  year.
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
