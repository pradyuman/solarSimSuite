...
%
%      ERROR('Property','Value',...) creates a new ERROR using the
%      given property value pairs. Unrecognized properties are passed via
%      varargin to error_OpeningFcn.  This calling syntax produces a
%      warning when there is an existing singleton*.
%
%      ERROR('CALLBACK') and ERROR('CALLBACK',hObject,...) call the
%      local function named CALLBACK in ERROR.M with the given input
%      arguments.
%
